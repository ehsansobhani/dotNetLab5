...
namespace Lab5.Pages.AnswerImages
{
    public class DeleteModel : PageModel
    {
        ...
        public DeleteModel(BlobServiceClient blobServiceClient, Lab5.Data.AnswerImageDataContext context)
        {
        ...
        public async Task<IActionResult> OnPostAsync(int? id)
        {
            ...
            if (AnswerImage != null)
            {
                ...
                try
                {
                    var containerName = containerNamesDictionary[AnswerImage.Question.Equals(Question.Computer) ? "a" : "b"];
